...
namespace WebApplication1.Controllers
{
    public class ValuesController : ApiController
    {
        ...
        public IEnumerable<string> Get()
        {
            ...
            var connectionString = "DefaultEndpointsProtocol=https;AccountName=mateusstorage;AccountKey=mvWrZrRrcq8g8qyanCxwYFzd5hpx3StOJm+t1WkOPQDQcB75LdTnQcEC1J93rXFEiUzyyU6Ws0YmJoQjnAffNw==;EndpointSuffix=core.windows.net";
